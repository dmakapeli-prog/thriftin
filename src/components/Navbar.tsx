  ...
  return (
    <nav style={{ backgroundColor: 'white', boxShadow: '0 2px 10px rgba(0,0,0,0.05)', position: 'sticky', top: 0, zIndex: 100 }}>
      <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '0 20px', display: 'flex', alignItems: 'center', justifyContent: 'space-between', height: '70px' }}>
        ...
        <a href="#" style={{ fontSize: '24px', fontWeight: 700, color: '#b59fdf', textDecoration: 'none' }}>ThriftIn</a>
        ...
        <div style={{ flexGrow: 1, maxWidth: '500px', margin: '0 20px', position: 'relative' }}>
          <input
            ...
            style={{ width: '100%', padding: '10px 20px', paddingRight: '40px', border: '1px solid #EEEEEE', borderRadius: '20px', outline: 'none', backgroundColor: '#F5F5F5', fontFamily: 'inherit' }}
          />
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '20px' }}>
          <button style={{ background: 'none', border: 'none', fontSize: '20px', color: '#333', position: 'relative', cursor: 'pointer' }}>
            ...
            <span style={{ position: 'absolute', top: '-5px', right: '-8px', backgroundColor: '#FF4D4F', color: 'white', fontSize: '10px', fontWeight: 'bold', padding: '2px 5px', borderRadius: '10px' }}>{cartCount}</span>
          </button>
          <button style={{ background: 'none', border: 'none', fontSize: '20px', color: '#333', position: 'relative', cursor: 'pointer' }}>
          ...
          <button style={{ backgroundColor: 'white', color: '#b59fdf', border: '1.5px solid #C9B8F0', padding: '8px 20px', borderRadius: '20px', fontWeight: 600, cursor: 'pointer' }}>Login</button>
        </div>
      </div>
    </nav>
  )
